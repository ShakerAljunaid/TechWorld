	...
	<div class="shell">
		...
		<div id="header">
			...
			<div id="search">
				<div class="search-holder hvr-hang">
				  <!--Make the form to get the criterion set in the search input box-->
					<form name="frmSearch " action="Search_page.php" method="get">					
						<input type="text"  dir="rtl" class="field light_hover" name="criterion" value="<?php echo $keyword; ?> " title="Ø§Ø§Ø³Ù… Ø§Ù„Ù…Ù†ØªØ¬" onfocus="clearText(this)" onblur="clearText(this)" />
						<input type="submit"  name="sbm" value="" class="submit-button   " id="btnHover"/>						
					</form>
			...
			<!-- END Search -->						
				<div class="cl"></div>
			<!-- Logo -->
			<h1 id="logo"><a title="Home" >[صفحة البحث]</a></h1>
...
<div id="pg_title"> <h3> [البحث] </h3>	</div>		
			<!-- END Top Navigation -->	
			<div class="cl"></div>		
		</div>
		<!-- END Header -->
	...
	<!-- Navigation -->
		...
		<div id="main">
			...
			<!-- END Slider -->
					...
					{$_SESSION['Not found']="!Not available rightnow!";
