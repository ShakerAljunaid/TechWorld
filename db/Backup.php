			...
			<div class="products">
              ...
              <div class="big-img"><a href="http://pixelsdaily.com/resources/photoshop/psds/flat-toggles-and-sliders/" target="_blank"><img src="Images/<?php echo $data['img'];?>"></a></div>
					...
					<div class="prd_options">
					 <div class="prod_details_tab">  <a href="Index.php?add='<?php echo $img;?> '" title="header=[Add to cart] body=[&nbsp;] fade=[on]"><img src="images/cart.gif" alt="" border="0" id="btn" class="left_bt" /> <a href="#" title="header=[Specials] body=[&nbsp;] fade=[on]"><img src="images/favs.gif" alt="" border="0" class="left_bt" /></a> <a href="#" title="header=[Gifts] body=[&nbsp;] fade=[on]"><img src="images/favorites.gif" alt="" border="0" class="left_bt" />
