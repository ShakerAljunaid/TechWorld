...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="cz"><head><title>تكنو ورلد </title>

<head>
	<title>تكنو ورلد </title>
  ...
  <!----------------------------------------------------------------------------------------->
	...
	//Instance of the class that has the functions of database connection
	 ...
	 //Call get all data function to show the data in the page 
	     $dataImage=$obj_img->get_all_prd('منوعات');
...
<body onload="loadScroll()"  onunload="saveScroll()" >
	<div class="shell">
		...
		<div id="header">
				...
				<div class="search-holder hvr-hang">
				  <!--Make the form to get the criterion set in the search input box-->
					<form name="frmSearch "action="Search_page.php" method="post">					
						<input type="text" class="field light_hover" name="criterion" value="اسم المنتج" title="ااسم المنتج"  />
			...
			<div class="cl"></div>
			<!-- Logo -->
			<h1 id="logo"><a title="Home" href="index.php">تكنو ورلد</a></h1>
			<!-- Top Navigation -->
			<div id="top-navigation">	
				<ul>
					<li>  <?php echo ' عناصر: ' . $obj_img->count_items().'|المجموع: '.'$'. $obj_img->subtotal();?>  </li>
					<li><a class="start hvr-hang   " title="حسابي" href="#"><span></span>حسابي</a></li>
					<li><a class="cart hvr-hang  " title="سلة المشتريات" href="#"><span></span>سلة المشتريات </a></li>
					<li><a class="end  hvr-hang  title="صفحة الخروج" href="#">صفحة الخروج<span></span></a></li>				
				</ul>		
			</div>				
			<!-- END Top Navigation -->	
			<div class="cl"></div>		
								...
								<div class="dd">
									<ul>
										...
										<li><a title="Drop down menu 3" href="#"><span class="sep-left"></span>محممولة </a></li>	
                                          ...
                                          <li><a title="Drop down menu 4" href="#"><span class="sep-left"></span>منوعاتات</a></li>										
									</ul>
								</div>
                                </li>
  ...
  <div class="popup">
    ...
    <span> <div class="checkout-button"><a href="cart.php" >صفحة الخروج</a></div></span> 
      ...
      <ul class="left_menu">
        <li class="odd"><a href="#">جولات</a></li>
        <li class="even"><a href="#">كمبيوترات</a></li>
        <li class="odd"><a href="#">لاب توبات</a></li>
        <li class="even"><a href="#">سيديهات</a></li>
        <li class="odd"><a href="#">طابعات</a></li>
        <li class="even"><a href="#">منوعات</a></li>
        <li class="odd"><a href="#">منوعاتات</a></li>
        <li class="even"><a href="#">اكسسورات للجولات</a></li>
      </ul>
	...
	<a href="Index.php?add='<?php echo $img;?> '" title="header=[Add to cart] body=[&nbsp;] fade=[on]"><img src="images/cart.gif" alt="" border="0" id="btn" class="left_bt hover_move" />		     
...
$( "#btn " ).click(function() {
   //This for callin the selected item and add its data into cart table
	 var name="<?php  echo $obj_img->add_to_cart($_REQUEST['add']); ?>";
