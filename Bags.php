...
<!DOCTYPE html >
<html >
<head><title> [تكنو ورلد [المنتجات -حقائب كمبيوتر</title>
 ...
 function clearText(field)
	...
	//Instance of the class that has the functions of database connection
	 ...
	 //Call get all data function to show the data in the page 
	     $dataImage=$obj_img->get_all_prd('حقائب كمبيوترات');
...
<body onload="loadScroll()"  onunload="saveScroll()" >
	...
	<!-- Header -->
		<div id="header">
			...
			<div class="cl"></div>
			<!-- Logo -->
			<h1 id="logo"><a title="Home" >[حقائب كمبيوتر]</a></h1>
...
<div id="pg_title"> <h3> [المنتجات-حقائب كمبيوتر] </h3>	</div>			
			<!-- END Top Navigation -->	
			<div class="cl"></div>		
		</div>
		<!-- END Header -->
