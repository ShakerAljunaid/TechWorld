...
<!DOCTYPE html>
<html >
<head><title> [تكنو ورلد [المنتجات -كمبيوترات محمولة</title>
 ...
 function clearText(field)
	...
	//Instance of the class that has the functions of database connection
	 ...
	 //Call get all data function to show the data in the page 
	     $dataImage=$obj_img->get_all_prd('كمبيوترات محموله');
...
<div id="pg_title"> <h3> [المنتجات-كمبيوترات محمولة] </h3>	</div>			
			<!-- END Top Navigation -->	
			<div class="cl"></div>		
		</div>
		<!-- END Header -->
...
$("#modal_trigger").leanModal({top : 100, overlay : 0.6, closeButton: ".modal_close" });
	...
	function updateAll(){
	 	$(".price").html("<php echo $obj_img->subtotal();?>");
	}
