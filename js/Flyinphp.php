...
<body>
			...
			<div id="search">
				<div class="search-holder">
					<form action="Search_page.php" method="post">					
						<input type="text" class="field" name="criterion" value="Keywords" title="Keywords" />
						<input type="submit"  name="sbmit" value="" class="submit-button" />						
					</form>
  ...
  <p> <marquee behavior="scroll" direction="left" onmouseover="stop()" onmouseout="start()"><font color="#FFFF99"><h3>30%off on all summer wear...Hurry!!!</h3></font><font color="#00CC99"><h4>Enjoy the pleasure of shopping with Fashion Shop...</h4></font></marquee><br>
      ...
      <div class="shopping_cart">
        ...
        <div  id="basket" class="cart_icon"><a href="#" title="header=[Checkout] body=[&nbsp;] fade=[on]"><img src="images/shoppingcart.png" alt="" width="48" height="48" border="0" /></a></div>
      </div>
    ...
    <!-- end of right content -->
		...
		<a href="Index.php?add='<?php echo $img;?> '" title="header=[Add to cart] body=[&nbsp;] fade=[on]"><img src="images/cart.gif" alt="" border="0" id="btn" class="left_bt" />			     
