...
<html >
<head>
<title> [تكنو ورلد [المنتجات -سيدهات</title>
 ...
 function clearText(field)
	...
	//Instance of the class that has the functions of database connection
	 ...
	 //Call get all data function to show the data in the page 
	     $dataImage=$obj_img->get_all_prd('سيديهات');
...
<body onload="loadScroll()"  onunload="saveScroll()" >
	...
	<!-- Header -->
		<div id="header">
			...
			<div class="cl"></div>
			<!-- Logo -->
			<h1 id="logo"><a title="Home" >[سيديهات]</a></h1>
...
<div id="pg_title"> <h3> [المنتجات-سيديهات] </h3>	</div>			
			<!-- END Top Navigation -->	
			<div class="cl"></div>		
		</div>
		<!-- END Header -->
			...
			<div id="footer">
				...
				<div id="footer-middle">
					<div class="col styles">
						<h3>مميزتنا</h3>
						<ul>
							<li><a title="gamer" href="javascript:void(0);"><span class="bullet"></span>التقنية العالية</a></li>
							<li><a title="abstract" href="javascript:void(0);"><span class="bullet"></span>ضمانة المنتجات</a></li>
							<li><a title="retro" href="javascript:void(0);"><span class="bullet"></span>منتجات نادرة</a></li>
							<li><a title="hi tech" href="javascript:void(0);"><span class="bullet"></span>نواكب التكنولوجيا الحديثة</a></li>
							<li><a title="for children" href="javascript:void(0);"><span class="bullet"></span>منتجات خاصة حسب الطلب</a></li>
							<li><a title="for ladies" href="javascript:void(0);"><span class="bullet"></span>منتجات مناسبة لكل الاعمار</a></li>							
						</ul>
					</div>
					<div class="col info">
						<h3>معلومات</h3>
