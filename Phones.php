...
<!DOCTYPE html>
<html >
<head><title> [تكنو ورلد [المنتجات -جوالات</title>
 ...
 function clearText(field)
	...
	//Instance of the class that has the functions of database connection
	 ...
	 //Call get all data function to show the data in the page 
	     $dataImage=$obj_img->get_all_prd('جوالات');
...
<body onload="loadScroll()"  onunload="saveScroll()" >
	<div class="shell">
		...
		<div id="header">
			...
			<div class="cl"></div>
			<!-- Logo -->
			<h1 id="logo"><a title="Home" >[كمبيوترات محموله]</a></h1>
...
<div id="pg_title"> <h3> [المنتجات-جوالات] </h3>	</div>		
			<!-- END Top Navigation -->	
			<div class="cl"></div>		
		</div>
		<!-- END Header -->
...
<!--End Signup and login-->
  ...
  <div class="popup">
    ...
    <!-- end of right content -->
		...
		<a href="javascript:void(0)" class="hvrlink" ><img src="Images/<?php echo $data['img'];?>" data-fullsize="Images/<?php echo $data['img'];?>" ></a>
              ...
              <div class="big-img"><a href="javascript:void(0)" target="_blank"><img src="Images/<?php echo $data['img'];?>"></a></div>
			...
			<!-- 	<input type='button' onClick=" $obj_img->add_to_cart('$img);" ><img src="images/cart.gif" alt="" border="0" id="btn" class="left_bt hover_move" />	-->
			 ...
			 <a href="javascript:void(0);" title="header=[Specials] body=[&nbsp;] fade=[on]"><img src="images/unfav .png" onclick="ChangeMe(this);"  alt="" border="0" class="left_bt hover_move"   />		
				...
				</a> <a href="javascript:void(0)" title="header=[Gifts] body=[&nbsp;] fade=[on]"><img src="images/favorites.gif" alt="" border="0" class="left_bt hover_move" />
