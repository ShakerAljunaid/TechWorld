...
<head>
	<title>[تكنو ورلد [الرئيسية </title>
 ...
 function clearText(field)
	...
	//Instance of the class that has the functions of database connection
	 ...
	 //Call get all data function to show the data in the page 
	     $dataImage=$obj_img->get_all_prd('الواجهات');
...
<!--End Signup and login-->
  ...
  <div class="popup">
	...
	<!-- List of the products avilable in the website-->
		...
		<a href="<?php echo $data['Link'];?>" class="hvrlink" ><img src="Images/<?php echo $data['img'];?>" data-fullsize="Images/<?php echo $data['img'];?>" ></a>
              ...
              <div class="big-img"><a href="<?php echo $data['Link'];?>" target="_blank"><img src="Images/<?php echo $data['img'];?>"></a></div>
